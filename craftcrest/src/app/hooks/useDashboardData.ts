...
export const useDashboardData = () => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      setLoading(false);
      setError((e as Error).message || 'Unknown error during data processing');
      setData(null);
    }
  }, [
    payments, orders, users, inventory, ratings,
    paymentsLoading, ordersLoading, usersLoading, inventoryLoading, ratingsLoading,
    paymentsError, ordersError, usersError, inventoryError, ratingsError,
  ]);
