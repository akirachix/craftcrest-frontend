...
import { Package, LayoutDashboard, Users, ShoppingCart, CreditCard, X } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const sidebarLinks= [
    ...
    {id:3, href: '/sellers', label: 'Sellers', icon: Users },
    {id:4, href: '/orders', label: 'Orders', icon: ShoppingCart },
    {id:5, href: '/payments', label: 'Payments', icon: CreditCard },
  ...
  return (
    <aside className="flex h-screen w-64 flex-col bg-[#5D070D] p-6 text-white shadow-lg ">
      <div className="mb-10 mt-4 flex-col items-center gap-2">
        ...
        <h1 className="text-3xl mt-5 ml-5 font-bold">Craft<span className='text-yellow-400'>Crest</span></h1>
      </div>
      <nav className="flex flex-1 flex-col border-t-1 border-white pt-5 gap-6 text-xl">
